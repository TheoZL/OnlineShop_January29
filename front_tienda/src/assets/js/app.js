...
function initPageTienda($) {
    ...
    window.onload = function () {
        $('.preloader').fadeOut(3000, function () { $('.preloader').remove(); });
    }
    ...
    $(function () {
        ...
        //         $("#amount").val("CRC " + ui.values[0] + " - CRC " + ui.values[1]);
        //     }
        // });
        $("#amount").val("CRC " + $("#slider-range").slider("values", 0) +
            " - CRC " + $("#slider-range").slider("values", 1));
    });
...
function scrollToFooter() {
    ...
    // Resaltar el texto "Contacto"
    var contactTitle = document.querySelector('.footer_cont');
    contactTitle.classList.add('text-highlighted');

    // Después de 1 segundo, quitar el resaltado
    setTimeout(function() {
        contactTitle.classList.remove('text-highlighted');
    }, 2000);
}


function iniciarConteo() {
    console.log("lee funcion iniciar")
    let countdown = 10;
