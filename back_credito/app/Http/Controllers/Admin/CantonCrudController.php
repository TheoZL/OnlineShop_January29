...
/**
 * Class CantonCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CantonCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Canton::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/canton');
        CRUD::setEntityNameStrings('Canton', 'Cantones');
    }
    ...
    {
        CRUD::setValidation(CantonRequest::class);
